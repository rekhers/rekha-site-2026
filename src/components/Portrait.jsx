...
export default function Portrait() {
  ...
  return (
    <figure className={styles.portrait}>
      ...
      >
        <Image className={styles.portraitPhoto} src="/bio-pic.jpg" alt="Rekha Tenjarla smiling, seated on a couch" width={3870} height={5796} sizes="(max-width: 600px) 46vw, (max-width: 1199px) 240px, 280px" />
